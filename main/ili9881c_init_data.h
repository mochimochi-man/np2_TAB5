// ILI9881C panel initialisation data for the M5Stack Tab5.
//
// Copied verbatim from the Tab5 BSP
// (managed_components/espressif__m5stack_tab5/priv_include/disp_init_data.h,
// Copyright 2026 Espressif Systems, Apache-2.0), for the same reason as
// st7123_init_data.h: that header sits in the component's priv_include and is
// not on any include path, and panel_tab5.cpp does the bring-up itself rather
// than through bsp_display_new().
//
// The earliest Tab5 units carry this panel with a GT911 touch controller.
// Like the ST7123 path, nothing here has been run on real hardware, so it uses
// the vendor driver with the vendor's own data rather than anything
// hand-rolled.
//
