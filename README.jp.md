...
**4 分割で書けば残ります。** どの部品も NVS に掛かりません。

**結合イメージでは消えます。** 0x0 から連続した 1 本のイメージなので、
パーティションテーブルと OTA データの間の隙間まで書き込まれ、NVS はその隙間の
中にあります。`np2_TAB5_0x0.bin` を書くと設定は毎回消えます。**M5Burner
からの導入もこちらです。**
